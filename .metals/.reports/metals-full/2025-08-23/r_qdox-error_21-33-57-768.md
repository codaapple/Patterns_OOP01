error id: file://<WORKSPACE>/src/patterns/zoe/Game.java
file://<WORKSPACE>/src/patterns/zoe/Game.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/patterns/zoe/Game.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/patterns/zoe/Game.java